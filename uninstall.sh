...
#
# --purge only ever deletes a directory inside ~/.local/share that is a Python
# virtualenv stamped by install.sh. Anything else, including a MAESTRAL_VENV
# that points somewhere broader, is refused before anything is touched.
#
