...
Panel {
  id: root
  moduleName: "io.github.ryankv.omarchy-maestral"
  ipcTarget: "io.github.ryankv.omarchy-maestral"
  manageIpc: false
        ...
        Column {
          ...
          Item {
            ...
            PanelHero {
              ...
              width: parent.width
              title: "Dropbox"
              meta: dropbox.active ? root.heroPhraseText : (dropbox.daemonRunning ? "Syncing paused" : "Maestral stopped")
          ...
          Column {
            ...
            Column {
              width: parent.width
              spacing: Style.spacing.labelGap
              InfoPair { visible: dropbox.email !== ""; label: "Account"; value: dropbox.email }
              InfoPair { label: "Stored"; value: Model.usageText(dropbox.usedBytes, dropbox.quotaBytes, dropbox.quotaKnown) }
              InfoPair { label: "Status"; value: dropbox.statusText }
            }
          }
  ...
  component LoginButton: CursorSurface {
    ...
    MouseArea {
      anchors.fill: parent
      hoverEnabled: true
      cursorShape: dropbox.installed ? Qt.PointingHandCursor : Qt.ArrowCursor
      enabled: dropbox.installed
      onEntered: {
    ...
    RowLayout {
      ...
      ColumnLayout {
        ...
        Text {
          textFormat: Text.PlainText
          Layout.fillWidth: true
          text: dropbox.installed ? "Login to Dropbox" : "Maestral is not installed"
          color: root.foreground
          font.family: root.fontFamily
          font.pixelSize: Style.font.body
        ...
        Text {
          textFormat: Text.PlainText
          Layout.fillWidth: true
          text: dropbox.installed ? "Link your account in a terminal window" : "Run install.sh from the plugin folder"
          color: root.dim
          font.family: root.fontFamily
